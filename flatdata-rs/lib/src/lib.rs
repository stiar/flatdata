...
//! This crate provides:
//!
//! * data structures for writing data to archives: [`StructBuf`], [`Vector`],
//!   [`ExternalVector`], [`MultiVector`]
//! * data structures for reading data from archives: [`ArrayView`],
//!   [`MultiArrayView`]
//! * resource storage backends for using archives: [`MemoryResourceStorage`],
//!   [`FileResourceStorage`]
//!
//! The generator is part of the [heremaps/flatdata] repository,
...
//!
//! # Examples
//! First you design a schema for the data you want to store, e.g.
//! if you'd want to store a list of prime factors for each natural number:
//! ``` flatdata
//! namespace prime {
...
//! ![diag][diag]
//!
//! Then you generate code using e.g. the [`generate`] utility in a `build.rs`
//! script and include it in your project. Now you can create a (disk-based)
//! archive and fill it with data:
//!
//! ```rust
//! # use flatdata::test_archive::*;
//! #
