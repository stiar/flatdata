...
"#;
    ...
    impl X {
        ...
        #[inline]
        pub fn data(&self) -> crate::ArrayView<super::n::A> {
    ...
    impl XBuilder {
        #[inline]
        pub fn set_data(&self, vector: &crate::ArrayView<super::n::A>) -> ::std::io::Result<()> {
            self.storage
                .write("data", schema::x::resources::DATA, vector.as_ref())
        }

        #[inline]
        pub fn start_data(&self) -> ::std::io::Result<crate::ExternalVector<super::n::A>> {
